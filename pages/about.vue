<template>
  <div class="About">
    ...
    <static-card>
      ...
      {{
        $t(
          '広島県内の公式情報をわかりやすくお伝えし、県内にお住まいの方や、県内に拠点を持つ企業の方、広島県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </static-card>
    <static-card>
    ...
    <static-card>
      ...
      <p>
        ...
        {{
          $t(
            'クッキーとは、Webコンテンツからの要求で利用者の手元の端末に一時的に保存されるデータのことで、当サイトではアクセス件数の正確な把握及びブラウザ表示機能の利便性向上等に利用することがあります。'
          )
        }}<br />
      </p>
      <p>
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、広島県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
